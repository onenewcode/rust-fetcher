...
function getEnvs(proxyObjs) {
    for (let i = 0; i < proxyObjs.length; i++) {
      ...
      get: function(target, property, receiver) {
        console.log("Method:", "get  ", "Object:", "${proxyObjs[i]}", "  Property:", property, "  Property type:", typeof property, ", Property value:", target[property], ", Property value type:", typeof target[property]);
        return target[property];
      },
      set: function(target, property, value, receiver) {
        console.log("Method:", "set  ", "Object:", "${proxyObjs[i]}", "  Property:", property, "  Property type:", typeof property, ", Property value:", value, ", Property value type:", typeof target[property]);
